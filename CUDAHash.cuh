...
#ifdef RTX5090_OPT
__device__ __forceinline__ void getSHA256_33_from_limbs_5090(uint8_t prefix02_03, const uint64_t x_le_limbs[4], uint32_t out_state[8]);
__device__ __forceinline__ void getHash160_33_from_limbs_5090(uint8_t prefix02_03, const uint64_t x_le_limbs[4], uint32_t out_words[5]);
#endif
#endif 
